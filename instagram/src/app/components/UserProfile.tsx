...
const UserProfile = ({ user }: Props) => {
  const { email, follower, following, name, posts, username, image } = user;
  const info = [
  ...
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-center py-12 border-b border-neutral-100">
